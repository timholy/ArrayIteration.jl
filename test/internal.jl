...
@test isa(sub(A, :, 1), AI.ContiguousCSC)
@test isa(sub(A, 1:2, 2), AI.ContiguousCSC)
@test isa(sub(A, :, 1:2), AI.ContiguousCSC)
@test !isa(sub(A, 1:2, 1:2), AI.ContiguousCSC)
@test !isa(sub(A, :, [1,2]), AI.ContiguousCSC)
@test !isa(sub(A, [1,2], 1), AI.ContiguousCSC)
